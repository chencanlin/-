package com.ccl.yuedu.ui.widget;
...
/**
 * Created by zuihuibao on 2016/2/25.
 */
public class LoadingDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public LoadingDialog create() {
            ...
            View inflate = LayoutInflater.from(context).inflate(R.layout.common_mask, null);
    ...
    public static LoadingDialog showLoadingDialog(Context context) {
        LoadingDialog loadingDialog = new LoadingDialog.Builder(context).create();
        loadingDialog.show();
        return loadingDialog;
    }

    public static LoadingDialog showLoadingDialog(Context context, String text) {
        LoadingDialog loadingDialog = new LoadingDialog.Builder(context).setMessage(text).create();
        loadingDialog.show();
        return loadingDialog;
    }

    public static LoadingDialog showLoadingDialog(Context context, int textId) {
        LoadingDialog loadingDialog = new LoadingDialog.Builder(context).setMessage(textId).create();
        loadingDialog.show();
        return loadingDialog;
    }

    public static LoadingDialog showLoadingDialog(Context context, OnKeyDownListener onKeyDownListener) {
        LoadingDialog loadingDialog = new LoadingDialog.Builder(context).setOnKeyDownListener(onKeyDownListener).create();
        loadingDialog.show();
        return loadingDialog;
    }

    public static LoadingDialog showLoadingDialog(Context context, String text, OnKeyDownListener onKeyDownListener) {
        LoadingDialog loadingDialog = new LoadingDialog.Builder(context).setMessage(text).setOnKeyDownListener(onKeyDownListener).create();
        loadingDialog.show();
        return loadingDialog;
    }

    public static LoadingDialog showLoadingDialog(Context context, int textId, OnKeyDownListener onKeyDownListener) {
        LoadingDialog loadingDialog = new LoadingDialog.Builder(context).setMessage(textId).setOnKeyDownListener(onKeyDownListener).create();
        loadingDialog.show();
        return loadingDialog;
    }
